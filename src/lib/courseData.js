// Reorganized Java Course Schedule (June 14, 2026 - August 16, 2026)
...
export const END_DATE = "2026-08-16";
...
export const courseSchedule = [
  ...
  },
  {
    ...
    "videos": [],
    "task": {
      "taskId": "proj_grade_setup",
      "title": "Class Grade Toolkit (Setup & Input Collection)",
      "description": "Build a command-line program that helps a student analyze exam scores and credit hours. Setup: prompt user for positive course count, read scores (0-100) and credit hours (>0) sequentially, rejecting invalid values with an error message and re-prompting until valid.",
      "projectInfo": {
  ...
  },
  {
    ...
    "videos": [],
    "task": {
      "taskId": "proj_grade_stats",
      "title": "Class Grade Toolkit (Basic Statistics & Palindrome Check)",
      "description": "Flesh out student details: calculate basic statistics (weighted average score, highest, lowest, and count above 80). Also, ask for the user's name and check if it is a case-insensitive palindrome.",
      "projectInfo": {
        "covers": "Ch 1–8 (Java basics, variables, I/O, expressions, conditionals, math/strings, loops, methods, arrays, matrices)",
        "goal": "Build a command-line program that helps a student analyze a set of exam scores and course credit hours, and produces a GPA report based on university grading regulations.",
        "requirements": [
  ...
  },
  {
    ...
    "videos": [],
    "task": {
      "taskId": "proj_grade_gpa",
      "title": "Class Grade Toolkit (Grades & GPA)",
      "description": "For each course, assign a letter grade based on the university scale. Calculate cumulative GPA as the credit-weighted average of course grade points, and determine the Overall General Estimate (Excellent, Very Good, Good, Pass, Weak, Very Weak).",
      "projectInfo": {
        "covers": "Ch 1–8 (Java basics, variables, I/O, expressions, conditionals, math/strings, loops, methods, arrays, matrices)",
        "goal": "Build a command-line program that helps a student analyze a set of exam scores and course credit hours, and produces a GPA report based on university grading regulations.",
        "requirements": [
  ...
  },
  {
    ...
    "task": {
      ...
      "description": "Complete your Class Grade Toolkit: calculate a 'bonus number' (digit sum of the highest score), print a single clean summary report, verify all inputs, and publish your project to GitHub with a solid README.md.",
      "projectInfo": {
        "covers": "Ch 1–8 (Java basics, variables, I/O, expressions, conditionals, math/strings, loops, methods, arrays, matrices)",
        "goal": "Build a command-line program that helps a student analyze a set of exam scores and course credit hours, and produces a GPA report based on university grading regulations.",
        "requirements": [
